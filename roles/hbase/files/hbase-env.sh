...
export HBASE_MASTER_OPTS="-Djava.security.auth.login.config=${HBASE_HOME}/conf/jaas.conf -Dsun.security.krb5.debug=true"
export HBASE_REGIONSERVER_OPTS="-Djava.security.auth.login.config=${HBASE_HOME}/conf/jaas.conf -Dsun.security.krb5.debug=true"
...
# export HBASE_SECURITY_LOGGER=DEBUG,DRFA
